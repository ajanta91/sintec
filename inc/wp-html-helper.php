...
// image default alt
if( !function_exists( 'sintec_img_default_alt' ) ){
	function sintec_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'sintec_img_tag' ) ){
	function sintec_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = sintec_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'sintec_anchor_tag' ) ){
	function sintec_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'sintec_heading_tag' ) ){
	function sintec_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'sintec_paragraph_tag' ) ){
	function sintec_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'sintec_other_tag' ) ){
	function sintec_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'sintec_button_element ' ) ){
	function sintec_button_element( array $args ){
